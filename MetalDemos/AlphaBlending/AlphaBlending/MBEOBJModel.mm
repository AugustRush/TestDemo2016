...
@interface MBEOBJModel ()
{
    ...
    std::vector<MBEIndexType> groupIndices;
    std::map<FaceVertex, MBEIndexType> vertexToGroupIndexMap;
}
...
- (void)endCurrentGroup
{
    ...
    NSData *indexData = [NSData dataWithBytes:groupIndices.data() length:sizeof(MBEIndexType) * groupIndices.size()];
